...
class SettingsFragment : PreferenceFragmentCompat() {
    ...
    private var listPrefence: ListPreference? = null
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        listPrefence = findPreference(resources.getString(R.string.pref_key_dark))
        listPrefence?.setOnPreferenceChangeListener { _, newValue ->
